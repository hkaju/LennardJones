...
plot(data$t, data$T, ylim=c(-5, 5), xlab="Steps", ylab="Energy per particle", type="n", main=expression(paste("Step size ", delta, "t = {timestep}")))
...
plot(data$t, data$T, xlab="Steps", ylab="Energy per particle", type="n", main=expression(paste("Step size ", delta, "t = {timestep}")))
lines(data$t, data$T, col="black")
